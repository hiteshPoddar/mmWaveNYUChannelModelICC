...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::NYUChannelModel::UpdatePeriod", TimeValue (MilliSeconds (100.0)));
  ...
  // settings for the NYU the channel
  Config::SetDefault ("ns3::NYUChannelModel::UpdatePeriod", TimeValue (MilliSeconds (100))); // interval after which the channel for a moving user is updated,
  ...
  mmwaveHelper->SetPathlossModelType ("ns3::NYUUMiPropagationLossModel");
  ...
  mmwaveHelper->SetEnbPhasedArrayModelAttribute ("NumColumns" , UintegerValue (2));
  mmwaveHelper->SetEnbPhasedArrayModelAttribute ("NumRows" , UintegerValue (2));
