...
public:
   ...
   * Destructor for the ThreeGppRmaChannelConditionModel class
   */
  virtual ~NYUChannelConditionModel () override;
 ...
 *
 * Computes the channel condition following the NYU Channel model for UMi scenario
 */
...
public:
   ...
   */
  virtual ~NYUUMiChannelConditionModel () override;

private:
  /**
   * Compute the LOS probability as specified in 
   * for the UMi scenario.
   *
   * \param a tx mobility model
   * \param b rx mobility model
   * \return the LOS probability
